...
// CHANGE THE READ MAPPING STEP HERE
    ...
    script:
    """
    smalt index mbov_smalt_index ${ref}
    smalt map -n ${task.cpus} mbov_smalt_index ${trim1} ${trim2} | samtools view -Sb | samtools sort -o ${trim1.baseName - ~/_trimmed_R*/}.bam
    """
    }
